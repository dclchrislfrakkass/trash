...
class flexSlider {
    ...
    function backendEnqueue(){
        ...
        wp_enqueue_script( 'jqueryFlexslider', plugins_url( '/js/modernizr.js', __FILE__ ));
        wp_enqueue_script( 'jqueryFlexslider', plugins_url( '/js/shCore.js', __FILE__ ));
        wp_enqueue_script( 'jqueryFlexslider', plugins_url( '/js/shBrushXml.js', __FILE__ ));
        wp_enqueue_script( 'jqueryFlexslider', plugins_url( '/js/shBrushJScript.js', __FILE__ ));
    }
